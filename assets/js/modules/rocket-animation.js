...
class RocketAnimation {
    ...
    updateRocketPosition() {
        ...
        // Optional: Add rotation based on movement
        const rotation = progress * 15; // Max 15 degrees
        this.rocketElement.style.transform = `translateY(-50%) translateX(${rocketPosition}px) rotate(${rotation}deg)`;
    }
}
