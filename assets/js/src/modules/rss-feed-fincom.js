/**
 * Financial Compliance RSS Feed Slideshow
 * Auto-rotating slideshow for recent posts with navigation
 */

class FinancialComplianceSlider {
    constructor() {
        this.slider = document.querySelector('[data-fc-slider]');
        if (this.slider) {
            this.slides = Array.from(this.slider.querySelectorAll('.fc-slide'));
            this.prevBtn = this.slider.querySelector('.fc-nav--prev');
            this.nextBtn = this.slider.querySelector('.fc-nav--next');
...
export default FinancialComplianceSlider;