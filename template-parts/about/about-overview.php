<?php
/**
 * About Story Section - Company origins and journey
 */
?>
...
<section class="about-story">
    <div class="container">
        ...
        <div class="about-story__content">
            ...
            <!-- Founding Story -->
            <div class="story-section story-section--founding">
            ...
            <!-- Mission Evolution -->
            <div class="story-section story-section--mission">
                <div class="story-section__visual">
                    <div class="story-stat">
                        <span class="story-stat__number">$2.1B+</span>
                        <span class="story-stat__label">Funding Secured</span>
                    </div>
                </div>
                <div class="story-section__text">
            ...
            <div class="story-section story-section--vision">
                ...
                <div class="story-section__visual">
                    <div class="story-stat">
                        <span class="story-stat__number">500+</span>
                        <span class="story-stat__label">Organizations Served</span>
                    </div>
                </div>
            </div>
            ...
            <div class="story-impact">
                <div class="story-impact__header">
                    <h3 class="story-impact__title">Impact by the Numbers</h3>
                </div>
                <div class="story-impact__stats">
                    <div class="impact-stat">
                        <div class="impact-stat__number">$2.1B+</div>
                        <div class="impact-stat__label">Total Funding Secured</div>
                    </div>
                    <div class="impact-stat">
                        <div class="impact-stat__number">500+</div>
                        <div class="impact-stat__label">Organizations Served</div>
                    </div>
                    <div class="impact-stat">
                        <div class="impact-stat__number">95%</div>
                        <div class="impact-stat__label">Client Success Rate</div>
                    </div>
                    <div class="impact-stat">
                        <div class="impact-stat__number">8+</div>
                        <div class="impact-stat__label">Years Experience</div>
                    </div>
                </div>
            </div>
