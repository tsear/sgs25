<?php
/**
 * Product Approach Section - Our methodology and philosophy
 */
?>
...
<section id="approach" class="product-approach">
    ...
    <div class="container">
        ...
        <div class="product-approach__content">
            ...
            <div class="approach-block approach-block--provide fade-column" data-delay="0">
                <div class="approach-block__icon">
        ...
        <div class="product-approach__philosophy">
            <blockquote class="approach-quote">
                <p class="approach-quote__text">"Grant funding should fuel innovation, not consume it. Our role is to handle the complexity so you can focus on the impact."</p>
                <cite class="approach-quote__author">— Dayna Shaw Sear, Founder & CEO</cite>
            </blockquote>
        </div>
    ...
    <div class="approach-divider approach-divider--bottom"></div>
